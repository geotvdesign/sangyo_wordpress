          ...
          <div class="card product--card">
            <div class="product__box">
              ...
              <div class="product__box__item">
                <h5 class="product__box__item__ttl">産機・電子機器</h5>
                <div class="product__box__item__detail">工作機械、食品機械、繊維機械等、従来型の産業機械、二次電池関連製造装置、ディスプレイ関連装置、フィルム製造装置、各種自動化設備</div>
              </div>
              <div class="product__box__item">
                <h5 class="product__box__item__ttl">自動車</h5>
                <div class="product__box__item__detail">セダン・ワンボックスカーなどの乗用車、電気自動車、高級輸入車、大型トラックやダンプなどの商用車</div>
              </div>
              <div class="product__box__item">
                <h5 class="product__box__item__ttl">建設機械</h5>
                <div class="product__box__item__detaily">建設機械、鉱山機械、中小型建機、発電機</div>
              </div>
              <div class="product__box__item">
                <h5 class="product__box__item__ttl">医療機器</h5>
                <div class="product__box__item__detail">放射線治療装置、大型医療機器、医療周辺サービスの提供及び施設維持管理に必要な機器</div>
              </div>
            </div>
          </div>
        </div>
